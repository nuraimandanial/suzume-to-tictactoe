...
export default function RegularTTT() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const data = await obj.ExtractLeaderBoard("treblecross", "easy");
      const data2 = await obj.ExtractLeaderBoard("treblecross", "medium");
      const data3 = await obj.ExtractLeaderBoard("treblecross", "hard");
      setTTT({
